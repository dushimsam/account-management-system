...
const AdminHeader = ({getUsers, setCardStatus}) => {
  return (
    <div className="container">
      <div className="cards row row-cols-12 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 mx-0">
        <div className="col mb-4 mb-lg-0" style={{cursor: "pointer"}} onClick={()=>setCardStatus("ALL")}>
          <Card
            label="All"
        ...
        <div className="col mb-4 mb-lg-0" onClick={()=>setCardStatus("UNVERIFIED")}>
          <Card
            label="UnVerified"
            value={30}
            icon={
        ...
        <div className="col mb-4 mb-lg-0"  onClick={()=>setCardStatus("PENDING")}>
          <Card
        ...
        <div className="col mb-4 mb-lg-0"  onClick={()=>setCardStatus("VERIFIED")}>
          <Card
            label="Verified"
            value={30}
            icon={
