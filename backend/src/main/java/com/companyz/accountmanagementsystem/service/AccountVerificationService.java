...
public class AccountVerificationService {
    ...
    public ResponseEntity<?> getAllByUser(Long id) {
    ...
    public ResponseEntity<?>  verifyAccount(Long id) {
    ...
    public ResponseEntity<?> uploadDocument(Long accountId, MultipartFile file) {
